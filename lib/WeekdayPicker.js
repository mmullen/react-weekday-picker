...
var WeekdayPicker = (function (_Component) {
  ...
  _createClass(WeekdayPicker, [{
    ...
    value: {
      ...
      ariaModifier: _propTypes2['default'].string,
      modifiers: _propTypes2['default'].object,

      locale: _propTypes2['default'].string,
      localeUtils: _propTypes2['default'].shape({
        formatWeekdayShort: _propTypes2['default'].func.isRequired,
        formatWeekdayLong: _propTypes2['default'].func.isRequired
      }),

      onWeekdayClick: _propTypes2['default'].func,
      onWeekdayMouseEnter: _propTypes2['default'].func,
      onWeekdayMouseLeave: _propTypes2['default'].func,
      onWeekdayTouchTap: _propTypes2['default'].func
    },
    enumerable: true
  }, {
    key: 'defaultProps',
